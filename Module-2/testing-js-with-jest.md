...
**2. Add a Test Script**  
This lesson uses ES Modules, while Jest normally prefers CommonJS, so to be able to use ES Modules we need to use Jest in experimental mode.
...
<small>[What Is a Pure Function in JavaScript?](https://www.freecodecamp.org/news/what-is-a-pure-function-in-javascript-acb887375dfe/)</small>
